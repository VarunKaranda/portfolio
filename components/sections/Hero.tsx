...
export default function Hero() {
  ...
  return (
     ...
     *  │                                │
     *  │  [fixed] scroll indicator      │  ← pinned to viewport bottom, fades on scroll
     *  └────────────────────────────────┘
     *
    ...
    <>
      ...
      {/* ── Scroll indicator — OUTSIDE section to avoid overflow-hidden / transform clipping ── */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: heroVisible ? 1 : 0 }}
        transition={{ delay: heroVisible ? 2 : 0, duration: 0.5 }}
        className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center gap-1 text-slate-400 pointer-events-none"
      >
